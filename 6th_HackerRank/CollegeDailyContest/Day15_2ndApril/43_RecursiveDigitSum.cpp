/* RECURSIVE DIGIT SUM : https://www.hackerrank.com/contests/iiits-ytp2026-0204/challenges/recursive-digit-sum
...
int helper(long long p) {
    
    if(p / 10 == 0) return p;
    // if(p < 10)  // => This is more clean 
